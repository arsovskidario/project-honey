        ...
        <nav className="bg-white border-b border-cfb491">
            <div className="max-w-full flex flex-wrap items-center justify-between mx-auto p-4 sticky top-0">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white md:900">
                        <li>
                            <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cfb491 md:p-0 md:cfb491  md:transparent">Honey</a>
                        </li>
                        <li>
                            <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cfb491 md:p-0 md:cfb491  md:transparent" >Pollen</a>
                        </li>
                        <li>
                            <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cfb491 md:p-0 md:cfb491  md:transparent">Gifts</a>
                        </li>
                    </ul>
                </div>
            </div>
