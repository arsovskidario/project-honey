...
export default function Banner() {
    ...
    return (
        <section id="banner" className="flex flex-col items-center bg-no-repeat bg-cover bg-center bg-[url('/src/assets/main-banner.png')] opacity-90 p-10 w-full h-full">
